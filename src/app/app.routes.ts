...
import { BookingSuccess } from './Components/booking/booking-success/booking-success';
...
export const routes: Routes = [
  ...
  { path: 'booking-success', component: BookingSuccess, canActivate: [RoleGuard], data: { roles: ['user'] }},];
